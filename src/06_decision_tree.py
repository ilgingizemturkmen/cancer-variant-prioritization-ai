...
- Save metrics, predictions and model visualization
...
METRICS_FILE = RESULTS_DIR / "decision_tree_metrics.json"
PREDICTIONS_FILE = RESULTS_DIR / "decision_tree_predictions.csv"
CONFUSION_MATRIX_FILE = FIGURES_DIR / "decision_tree_confusion_matrix.png"
TREE_FIGURE_FILE = FIGURES_DIR / "decision_tree_structure.png"
FEATURE_IMPORTANCE_FILE = FIGURES_DIR / "decision_tree_feature_importance.png"
...
def train_model(
    ...
    """
    Train a class-balanced Decision Tree.

    max_depth limits tree complexity and reduces overfitting.
...
def create_tree_figure(
    ...
    """Visualize the upper levels of the decision tree."""
    FIGURES_DIR.mkdir(parents=True, exist_ok=True)
    ...
    plt.title("Decision Tree Structure — First Three Levels")
    plt.tight_layout()
    plt.savefig(
        TREE_FIGURE_FILE,
        dpi=300,
...
def create_feature_importance_figure(
    ...
    """Plot the most important Decision Tree features."""
    FIGURES_DIR.mkdir(parents=True, exist_ok=True)
